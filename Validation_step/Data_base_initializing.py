...
a = data_base_Population_poverty2012_rural['NOM_MUN']
b = data_base_Population_poverty2012_rural['CODIGO']
b = data_base_Population_poverty2012_rural['%Satisfied basic needs']
...
first = data_base_Population_poverty2012_rural[['Pop','% No poor population in 2012','%Poor population in 2012','index_pov','%Satisfied basic needs','Electrification rate','COD_DEP','NOM_MUN','CODIGO']]
...
third = data_base_CNPV2012_rural[['Provincia','Municipio','Comunidad','Depto','Hog_Elec','Hogares']]
...
#%% probably useless now that there is the validation file ready 
...
## new way to do it without increasing to match the layers fo dict
    ...
    if (data['Alt'] <= data['Elevation_transition']):
        ...
        with open('C:/Users/pietr/Spyder/RAMP_spyder/Initializing_json/Output_files/Final_input_file%d.json' %i, 'w') as f:
            ...
            data.update(d_lowlands) # how to sum one dictionary to another without creating to many layers in the structurer of the data 
...
## OSS : TODO improve the code maybe the two for loop are redundant
